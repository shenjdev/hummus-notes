        ...
        <main className="">
          <article className="w-full"> 
            ...
            <div className="max-w-[65ch] mx-auto px-5 md:px-8">
              <p className="text-xl sm:text-3xl font-extrabold mb-2 sm:mb-5 hover:cursor-pointer">
                Why Chromakopia was released at the peak of Tyler's career
              </p>
              <div className="nav-links text-sm sm:text-lg text-[#919191] flex gap-2 mb-2 sm:mb-5">
                <a>
                  James Shen
                </a>
                <a>
